...
<section id="home">      
 ...
 <div class="panel-heading">
  ...
  <a class="btn btn-green animated fadeInUp" href="Restaurants/create">Add New Restaurant</a>
</div>
   ...
   <table class="table table-bordered ">
    <thead>
     <tr>
      ...
      <th>Created By</th>
      <th>Delete</th>
      <th>Edit Restaurant Information</th>
    </tr>
  </thead>
  <tbody>
   ...
   <tr>
    ...
    <td class="restaurantThumb"><img class="restaurantThumb" src="{{$restaurant->image}}">
      <style>img {
        max-width: 200px;
        height: auto;
      }
   ...
   <td>
     <a class="btn btn-green" href="Restaurants/{{$restaurant->id}}/edit">Edit Information</a>
   </td>
 </tr>
 @endforeach
</tbody>
