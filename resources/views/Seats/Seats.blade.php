        ...
        <div class="container">
         ...
         <nav class="collapse navbar-collapse navbar-right" role="Navigation">
          <ul id="nav" class="nav navbar-nav">
            ...
            <li class="current"><a href="Seats">Pricing</a></li>
...
<section id="home">      
 ...
 <div class="panel-heading">
  ...
  <a class="btn btn-green animated fadeInUp" href="Seats/create">Add Pricing</a>
</div>
<div class="panel-body">
  ...
  <tbody>
   ...
   <tr>
    <td>{{$seat->title}}</td>
    <td>{{$seat->price}}</td>
    <td class="seatThumb"><img class="seatThumb" src="{{$seat->image}}">
      <style>
      img {
        max-width: 200px;
        height: auto;
   ...
   <td>
     <a class="btn btn-green" href="Seats/{{$seat->id}}/edit">Edit Pricing</a>
   </td>
 </tr>
 @endforeach
</tbody>
