      ...
      <header id="navigation" class="navbar navbar-inverse">
         ...
         <nav class="collapse navbar-collapse navbar-right" role="Navigation">
          <ul id="nav" class="nav navbar-nav">
            ...
            <li class="current"><a href="Payments">Payments</a></li>
...
<section id="home">      
 ...
 <div class="panel-heading">
   ...
   <a class="btn btn-green animated fadeInUp" href="Payments/create">Add Your Payment Here!</a>
      ...
      <table class="table table-bordered ">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <a class="btn btn-green" href="Payments/{{$payment->id}}/edit">Edit Payment</a>
               </td>
            </tr>
            @endforeach
         </tbody>
